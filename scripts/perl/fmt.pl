#!/usr/bin/env perl
# fmt.pl - format scripts in awk, csh, ksh, perl, sh
#
# we do:
...
# "if ... \nthen", for ... in\ndo", "while/until ... \ndo", "fn()\n{"
#
# to have fmt.pl reformat itself (a fair test, yes?) try:
#	fmt.pl     fmt.pl fmt.pl.new	# use tabs for indents
#	fmt.pl -s4 fmt.pl fmt.pl.new	# indent is fou
